...
class InvoiceController extends Controller
{
    ...
    {
        $invoices = Invoices::with('enrollment.student.user', 'enrollment.course.subject', 'payments')->get();
    ...
    {
        $invoice->load('enrollment.student.user', 'enrollment.course.subject', 'payments');
