...
ENV PORT=10000
EXPOSE 10000
CMD php artisan migrate --force && php artisan db:seed --class=SeedSchoolData --force && php artisan config:cache && php artisan route:cache && php artisan serve --host=0.0.0.0 --port=10000