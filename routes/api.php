...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::apiResource('/subject', SubjectController::class)->middleware('role:1,2');
    ...
    Route::apiResource('/enrollment', EnrollmentController::class)->middleware('role:1,2');
    Route::apiResource('/exam', ExamController::class)->middleware('role:1,2');
    Route::apiResource('/course', CourseController::class)->middleware('role:1,2');
    Route::apiResource('/invoice', InvoiceController::class)->middleware('role:1');
    Route::apiResource('/result', ResultController::class)->middleware('role:1,2');
    ...
    Route::apiResource('/teacher-course', TeacherCourseController::class)->middleware('role:1,2');
    Route::apiResource('/schedule', ScheduleController::class)->middleware('role:1,2');
